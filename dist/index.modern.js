...
var ATelefono = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (visible) {
      ...
      }, this.props.titulo), /*#__PURE__*/React$1.createElement(FiSearch, {
        className: "atelefono-titulo-items"
      })), /*#__PURE__*/React$1.createElement("div", {
...
export { AArchivos, ABoton, ACajaTexto, ACheckBox, aControl as AControl, AEtiqueta, AExpReg, ALogoCarga, AMultimedia, APanel, ATabla, ATelefono, ATitulosPantallas };
